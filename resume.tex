...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Senior Staff Software Engineer}{2017 - Present}
      ...
      \resumeItemListStart
        ...
        \resumeItem{Created and maintained customizations to the Android framework for multiple concurrent products, including device performance optimizations}
        ...
        \resumeItem{Modified Linux kernel device trees to support new device GPIOs}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Java, C/C++, Bash, Make, Gradle, Ruby, JavaScript, Python} \\
